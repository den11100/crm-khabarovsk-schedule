...
| Поле                    | Тип     | Описание                                              |
|-------------------------|---------|--------------------------------------------------------|
| crm_room_id **или** erp_employee_doctor_id | int     | Уникальный идентификатор врача/кабинета               |
| analysis_id            | int     | ID теста (из `erp.analysis.id`)                      |
| dt                     | string  | Дата процедуры (в формате `Y-m-d`)                    |
| time_start             | string  | Время начала процедуры (в формате `H:i:s`)            |
| time_end               | string  | Время окончания процедуры (в формате `H:i:s`)         |
